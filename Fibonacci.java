package com.example.waleed.clarity;

import com.example.waleed.clarity.util.SystemUiHider;
...
public class Fibonacci extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View contentView = findViewById(R.id.ansView);
    ...
    private String getFibSequence(int n){
        ...
        int count = 0;
        if (n > 0) { fib.add(1); count++; }
        if (n > 1) { fib.add(1); count++; }
        while (count < n) {
